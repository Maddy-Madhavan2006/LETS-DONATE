...
const compnayName = "Let's Donate";
			...
			>
				...
				<div className="flex lg:flex-1">
					<a href="/" className="-m-1.5 p-1.5">
						...
						{/* ✅ White logo from public */}
						<img className="w-auto h-20" src="/letsdonate.png" alt="White Logo" />
					</a>
				</div>
			...
			>
				...
				<Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full px-6 py-6 overflow-y-auto bg-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
					<div className="flex items-center justify-between">
						<a href="/" className="-m-1.5 p-1.5">
							<span className="sr-only">{compnayName}</span>
							{/* ✅ Black logo from public */}
							<img className="w-auto h-12" src="/letsdonate.png" alt="Black Logo" />
						</a>
						<button
							type="button"
							...
							<div className="py-6 space-y-2">
								{navigation.map((item) => (
									<NavLink
										...
										to={item.href}
										className={`-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-dark ${
											item.secondLast &&
