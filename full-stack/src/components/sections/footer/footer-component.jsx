...
const FooterComponent = () => {
	...
	const contactLinks = [
		...
		},
		{
			...
			link: "mailto:letsdonate@gmail.com",
		},
		{
			title: "Tiruchirappalli,Tamil Nadu, India",
			link: "https://goo.gl/maps/QCLpYP3yyUqhttps://www.google.com/maps/place/Tiruchirappalli,+Tamil+Nadu/@10.8160024,78.6066246,12z/data=!3m1!4b1!4m6!3m5!1s0x3baaf50ff2aecdad:0x6de02c3bedbbaea6!8m2!3d10.7904833!4d78.7046725!16zL20vMDE5Zmx2?entry=ttu&g_ep=EgoyMDI1MDkxNy4wIKXMDSoASAFQAw%3D%3DdT8HA7",
		},
		{
			title: "Open 24/7",
			link: "/contact",
				...
				<div className="first-section-wrapper grid sm:grid-cols-[1.5fr_1fr_1fr] gap-10">
					<div className="flex flex-col footer-col first-col">
						<h2 className="not-italic font-bold text-[40px] leading-[55px] text-white">
							LETS <span className="text-[red]">DONATE</span>
						</h2>
