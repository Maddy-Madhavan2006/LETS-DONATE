...
--
-- Host: localhost    Database: letsdonate_db
-- ------------------------------------------------------
...
--
-- Table structure for table `host_blood_drive`
--

DROP TABLE IF EXISTS `host_blood_drive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `host_blood_drive` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `phone` varchar(50) NOT NULL,
...
--
-- Dumping data for table `host_blood_drive`
--

LOCK TABLES `host_blood_drive` WRITE;
/*!40000 ALTER TABLE `host_blood_drive` DISABLE KEYS */;
/*!40000 ALTER TABLE `host_blood_drive` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-09-28 12:17:45
